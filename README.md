...
Project Overview
Wayanad district, known for its rich biodiversity and dense forests, is increasingly vulnerable to forest fires due to changing climate conditions and human activity. This study uses space-based data and GIS analysis to identify high-risk zones and support preventive management strategies.
...
3. **Frequency analysis:** Assigning weights to influencing factors  
4. **Fire Risk Zonation:** Classification into very low to very high-risk zones
5. **Validation:** Used AUC-ROC to validate the final results 
...
Authors:
Jeevan M.P (First author), 
Husna Nazeer,
Athul B,
Dr. Sumith Satheendran (Corresponding Author)
